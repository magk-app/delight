  ...
  return (
    <div className="space-y-6 overflow-y-auto max-h-full scrollbar-thin scrollbar-thumb-slate-700 scrollbar-track-transparent pr-2">
      ...
      <motion.div
        ...
        className="bg-slate-800/80 backdrop-blur-xl rounded-xl shadow-2xl p-4 sm:p-6 border border-slate-700/50"
      >
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex items-center gap-3 sm:gap-4">
            <div className="p-2 sm:p-3 bg-gradient-to-br from-purple-500 to-indigo-600 rounded-lg flex-shrink-0">
