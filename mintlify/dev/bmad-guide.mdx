---
title: "BMAD Developer Guide"
description: "Complete workflow guide for developing stories using BMAD (Business-Managed Agile Development) methodology"
icon: "rocket"
---
...
<Note>
For detailed setup instructions with troubleshooting, see [Setup Guide](./setup.mdx) (~15 minutes)
</Note>
...
Read the complete story and extract:
...
<Tip>
Only have 1-2 stories "in-progress" at a time. Focus beats multitasking.
</Tip>
...
<Tip>
Take a 15-minute break before self-review. Fresh eyes catch more issues.
</Tip>
